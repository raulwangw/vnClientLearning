...
class QtdWidgetData(object):
    """ Qtd's Widget Data Using for create Picture Frame """
...
class QtdMDData(object):
    
    def __init__(self):
        self.qtdMarketID = "qtdMarketID"
        ...
        self.totalhand = 'totalhand'
        self.changehand = 'changehand'
        self.volumerate = 'volumerate'
        self.nowhand = 'nowhand'
...
class QtdSSelStrastic(object):
    
    def __init__(self):
        self.qtdStockSelectStratistic = EMPTY_STRING
        self.stockid = EMPTY_STRING
        self.curprice = EMPTY_STRING
        self.uppercent = EMPTY_STRING
