...
class MainWindow(QtGui.QMainWindow):
    ...
    def initMenu(self):
        ...
        connectQtdAction = QtGui.QAction(u'连接QTD', self)
        connectQtdAction.triggered.connect(self.connectQtd)
