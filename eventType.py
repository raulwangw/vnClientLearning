...
EVENT_COMMISSION = 'eCommission'        # 委托事件
EVENT_CAPITAL = 'eCapital'              # 资金事件 
# CTA模块相关
...
EVENT_DAILY_KLINE = "event_daily_kline" #daily kLine Event
FRAME_DAILY_KLINE = "frame_daily_kline" #daily kLine Frame

EVENT_MD = "event_md" #event of md
EVENT_SSELSTRATIS = "event_sselstratis" #event of stock selected stratistic
